...
if [ "$release" == "6" ];then
	wget -O /etc/init.d/redis $runner_url/opt/qiangidc/config/redis/redis.init
	...
	wget -O /usr/lib/systemd/system/redis.service $runner_url/opt/qiangidc/config/redis/redis.service
