...
function Installall(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/qiangidc_pre.sh -O qiangidc_pre.sh;sh qiangidc_pre.sh | tee $dir04/qiangidc_pre.log
}
function Installcdn(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/qiangidc_pre.sh -O qiangidc_pre.sh;sh qiangidc_pre.sh no | tee $dir04/noqiangidc_pre.log
}
function Check(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/check.sh -O check.sh;sh check.sh | tee $dir04/check.log
}
function Resql(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/iset.sh -O iset.sh;sh iset.sh | tee $dir04/iset.log
}
function Upyum(){
	if [ "$release" == "8" ];then
...
function Uninstall(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/uninstall.sh -O uninstall.sh;sh uninstall.sh | tee $dir04/uninstall.log
}
function Rephp(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/php_remove.sh -O php_remove.sh;sh php_remove.sh | tee $dir04/php_remove.log
}
function SetDNS(){
	echo -e "———————————————————————————
...
function install_php(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/php_compile.sh -O php_compile.sh | tee $dir04/php_compile-01.log
...
function install_php_force(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/php_compile.sh -O php_compile.sh | tee $dir04/php_compile-02.log
...
function install_phpc(){
	cd $dir03
	rm -f $dir04/php*.log
	wget -q $runner_url/opt/qiangidc/shell/php_rapidly.sh -O php_rapidly.sh | tee $dir04/php_rapidly-01.log
...
function install_phpc_force(){
	cd $dir03
	rm -f $dir04/php*.log
	wget -q $runner_url/opt/qiangidc/shell/php_rapidly.sh -O php_rapidly.sh | tee $dir04/php_rapidly-02.log
...
function install_ioncube(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/ioncube.sh -O ioncube.sh;sh ioncube.sh | tee $dir04/ioncube.log
}
function install_ixed(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/ixed.sh -O ixed.sh;sh ixed.sh | tee $dir04/ixed.log
}
function phpini(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/php_ini.sh -O php_ini.sh;sh php_ini.sh | tee $dir04/php_ini.log
}
function install_mysql(){
	...
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/mysql_install.sh -O mysql_install.sh;sh mysql_install.sh $mysql_var $mysql_root_password | tee $dir04/mysql_install.log
}
...
function install_kangle(){
	...
	if [ "$YORN" = "2" ]; then
		...
		wget -q $runner_url/opt/qiangidc/shell/kangle.sh -O kangle.sh;sh kangle.sh $kangle_ver 0 | tee $dir04/kangle.log
	elif [ "$YORN" = "3" ]; then
		kangle_ver="3.5.14.13";
		wget -q $runner_url/opt/qiangidc/shell/kangle.sh -O kangle.sh;sh kangle.sh $kangle_ver 1 | tee $dir04/kangle.log
	elif [ "$YORN" = "4" ]; then
...
function install_easypanel(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/easypanel.sh -O easypanel.sh;sh easypanel.sh force | tee $dir04/easypanel.log
}
function install_phpmyadmin(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/phpmyadmin.sh -O phpmyadmin.sh;sh phpmyadmin.sh | tee $dir04/phpmyadmin.log
}
function setvhms(){
	wget -q $runner_url/opt/qiangidc/shell/vhms.sh -O vhms.sh;sh vhms.sh | tee $dir04/whms.log
}
function Update(){
	cd $dir03
...
function Easypanel_view(){
	cd $dir03
	wget -q $runner_url/opt/qiangidc/shell/view.sh -O view.sh;sh view.sh | tee $dir04/view.log
}
function Resetpwd(){
	clear
...
function Ipset(){
	...
	if [ "$YORN" = "1" ]; then
		...
		wget -q $runner_url/opt/qiangidc/config/iptables/iptables.xml -O /vhs/kangle/ext/iptables.xml
		/vhs/kangle/bin/kangle --reboot
...
function Fail2ban(){
	...
	if [ "$YORN" = "1" ]; then
		...
		wget -q $runner_url/opt/qiangidc/config/Fail2ban/jail.local -O /etc/fail2ban/jail.d/jail.local
		if [ "$release" -eq "6" ]; then
...
function cdnbest()
{
	wget -q $runner_url/opt/qiangidc/shell/cdnbest.sh -O cdnbest.sh;sh cdnbest.sh | tee $dir04/cdnbest.log
}

function AutoDisk()
{
	wget -q $runner_url/opt/qiangidc/shell/auto_disk.sh -O auto_disk.sh;sh auto_disk.sh | tee $dir04/auto_disk.log
}

function InstallRedis()
{
	wget -q $runner_url/opt/qiangidc/shell/redis.sh -O redis.sh;sh redis.sh | tee $dir04/redis.log
}
...
function mysql_ini(){
	...
	if [ "$mysql_ver" = "8" ]; then
		wget -q $runner_url/opt/qiangidc/config/mysql8.0/my${MYNUM}.cnf -O /etc/my.cnf
	elif [ "$mysql_ver" = "7" ]; then
		wget -q $runner_url/opt/qiangidc/config/mysql5.7/my${MYNUM}.cnf -O /etc/my.cnf
	else
		wget -q $runner_url/opt/qiangidc/config/mysql5.6/my${MYNUM}.cnf -O /etc/my.cnf
	fi
