...
function Installall(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/kangle10_pre.sh -O kangle10_pre.sh;sh kangle10_pre.sh | tee ${dir04}/kangle10_pre.log
}
function Installcdn(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/kangle10_pre.sh -O kangle10_pre.sh;sh kangle10_pre.sh no | tee ${dir04}/nokangle10_pre.log
}
function Check(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/check.sh -O check.sh;sh check.sh | tee ${dir04}/check.log
}
function Resql(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/iset.sh -O iset.sh;sh iset.sh | tee ${dir04}/iset.log
}
function Upyum(){
	if [ "$release" == "8" ];then
...
function Uninstall(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/uninstall.sh -O uninstall.sh;sh uninstall.sh | tee ${dir04}/uninstall.log
}
function Rephp(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/php_remove.sh -O php_remove.sh;sh php_remove.sh | tee ${dir04}/php_remove.log
}
function SetDNS(){
	echo -e "———————————————————————————
...
function install_php(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/php_compile.sh -O php_compile.sh | tee ${dir04}/php_compile-01.log
...
function install_php_force(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/php_compile.sh -O php_compile.sh | tee ${dir04}/php_compile-02.log
...
function install_phpc(){
	cd ${dir03}
	rm -f ${dir04}/php*.log
	wget -q ${mpcdn_2220}/opt/kangle10/script/php_rapidly.sh -O php_rapidly.sh | tee ${dir04}/php_rapidly-01.log
...
function install_phpc_force(){
	cd ${dir03}
	rm -f ${dir04}/php*.log
	wget -q ${mpcdn_2220}/opt/kangle10/script/php_rapidly.sh -O php_rapidly.sh | tee ${dir04}/php_rapidly-02.log
...
function install_ioncube(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/ioncube.sh -O ioncube.sh;sh ioncube.sh | tee ${dir04}/ioncube.log
}
function install_ixed(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/ixed.sh -O ixed.sh;sh ixed.sh | tee ${dir04}/ixed.log
}
function phpini(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/php_ini.sh -O php_ini.sh;sh php_ini.sh | tee ${dir04}/php_ini.log
}
function install_mysql(){
	...
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/mysql_install.sh -O mysql_install.sh;sh mysql_install.sh $mysql_var $mysql_root_password | tee ${dir04}/mysql_install.log
}
...
function install_kangle(){
	...
	if [ "$YORN" = "2" ]; then
		...
		wget -q ${mpcdn_2220}/opt/kangle10/script/kangle.sh -O kangle.sh;sh kangle.sh $kangle_ver 0 | tee ${dir04}/kangle.log
	elif [ "$YORN" = "3" ]; then
		kangle_ver="3.5.14.13";
		wget -q ${mpcdn_2220}/opt/kangle10/script/kangle.sh -O kangle.sh;sh kangle.sh $kangle_ver 1 | tee ${dir04}/kangle.log
	elif [ "$YORN" = "4" ]; then
...
function install_easypanel(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/easypanel.sh -O easypanel.sh;sh easypanel.sh force | tee ${dir04}/easypanel.log
}
...
function setvhms(){
	wget -q ${mpcdn_2220}/opt/kangle10/script/vhms.sh -O vhms.sh;sh vhms.sh | tee ${dir04}/whms.log
}
function Update(){
	cd ${dir03}
...
function Easypanel_view(){
	cd ${dir03}
	wget -q ${mpcdn_2220}/opt/kangle10/script/view.sh -O view.sh;sh view.sh | tee ${dir04}/view.log
}
function Resetpwd(){
	clear
...
function Ipset(){
	...
	if [ "$YORN" = "1" ]; then
		...
		wget -q ${mpcdn_2220}/opt/kangle10/conf/iptables/iptables.xml -O /vhs/kangle/ext/iptables.xml
		/vhs/kangle/bin/kangle --reboot
...
function Fail2ban(){
	...
	if [ "$YORN" = "1" ]; then
		...
		wget -q ${mpcdn_2220}/opt/kangle10/conf/Fail2ban/jail.local -O /etc/fail2ban/jail.d/jail.local
		if [ "$release" -eq "6" ]; then
...
function cdnbest()
{
	wget -q ${mpcdn_2220}/opt/kangle10/script/cdnbest.sh -O cdnbest.sh;sh cdnbest.sh | tee ${dir04}/cdnbest.log
}

function AutoDisk()
{
	wget -q ${mpcdn_2220}/opt/kangle10/script/auto_disk.sh -O auto_disk.sh;sh auto_disk.sh | tee ${dir04}/auto_disk.log
}

function InstallRedis()
{
	wget -q ${mpcdn_2220}/opt/kangle10/script/redis.sh -O redis.sh;sh redis.sh | tee ${dir04}/redis.log
}
...
function mysql_ini(){
	...
	if [ "$mysql_ver" = "8" ]; then
		wget -q ${mpcdn_2220}/opt/kangle10/conf/mysql8.0/my${MYNUM}.cnf -O /etc/my.cnf
	elif [ "$mysql_ver" = "7" ]; then
		wget -q ${mpcdn_2220}/opt/kangle10/conf/mysql5.7/my${MYNUM}.cnf -O /etc/my.cnf
	else
		wget -q ${mpcdn_2220}/opt/kangle10/conf/mysql5.6/my${MYNUM}.cnf -O /etc/my.cnf
	fi
